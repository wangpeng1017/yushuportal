<template>
  <doc-alert title="功能权限" url="https://iimake.com/resource-permission" />
  <doc-alert title="数据权限" url="https://iimake.com/data-permission" />
...
import RoleAssignMenuForm from './RoleAssignMenuForm2.vue'

<template>
  <doc-alert title="OAuth 2.0（SSO 单点登录)" url="https://iimake.com/oauth2/" />
  ...
  <ContentWrap>
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column label="访问令牌的有效期" width="160" align="center" prop="accessTokenValiditySeconds">
        <template #default="scope">{{ scope.row.accessTokenValiditySeconds }} 秒</template>
      </el-table-column>
      <el-table-column label="刷新令牌的有效期" width="160" align="center" prop="refreshTokenValiditySeconds">
        <template #default="scope">{{ scope.row.refreshTokenValiditySeconds }} 秒</template>
      </el-table-column>
      <el-table-column label="授权类型" width="120" align="center" prop="authorizedGrantTypes">
        <template #default="scope">
          <el-tag
      ...
      <el-table-column label="操作" align="center" width="160" fixed="right">
        <template #default="scope">
          <el-button
            ...
            :disabled="scope.row.defaultFlag === true"
...
import ClientAssignMenuForm from './ClientAssignMenuForm.vue'

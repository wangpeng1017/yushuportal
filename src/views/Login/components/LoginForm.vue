...
const ssoLogin = async () => {
    ...
    window.location.href = `${import.meta.env.VITE_IIMAKE_SSO_URL}?client_id=${import.meta.env.VITE_IIMAKE_CLIENT_ID}&response_type=code&auto_approve=false&scope=%7B%22user.read%22%3Atrue%7D&redirect_uri=${encodeURIComponent(redirect)}&state=`+new Date().getTime()
}

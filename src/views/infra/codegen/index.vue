<template>
  <doc-alert title="代码生成（单表）" url="https://iimake.com/new-feature/" />
  <doc-alert title="代码生成（树表）" url="https://iimake.com/new-feature/tree/" />
  <doc-alert title="代码生成（主子表）" url="https://iimake.com/new-feature/master-sub/" />
  <doc-alert title="单元测试" url="https://iimake.com/unit-test/" />

    ...
    items: [
      {
        ...
        iconUrl: 'http://mall.iimake.com/static/images/1-001.png',
        activeIconUrl: 'http://mall.iimake.com/static/images/1-002.png'
      },
      {
        text: '分类',
        url: '/pages/index/category?id=3',
        iconUrl: 'http://mall.iimake.com/static/images/2-001.png',
        activeIconUrl: 'http://mall.iimake.com/static/images/2-002.png'
      },
      {
        text: '购物车',
        url: '/pages/index/cart',
        iconUrl: 'http://mall.iimake.com/static/images/3-001.png',
        activeIconUrl: 'http://mall.iimake.com/static/images/3-002.png'
      },
      {
        text: '我的',
        url: '/pages/index/user',
        iconUrl: 'http://mall.iimake.com/static/images/4-001.png',
        activeIconUrl: 'http://mall.iimake.com/static/images/4-002.png'
      }
    ]
  }

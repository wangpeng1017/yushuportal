<template>
  <doc-alert title="用户体系" url="https://iimake.com/user-center/" />
  <doc-alert title="三方登陆" url="https://iimake.com/social-user/" />
  <doc-alert title="Excel 导入导出" url="https://iimake.com/excel-import-and-export/" />

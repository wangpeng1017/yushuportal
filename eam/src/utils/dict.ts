...
export enum DICT_TYPE {
  ...
  STRATEGY_OPEN_STATUS = 'strategy_open_status',
  STRATEGY_PUTAWAY_STRATEGYTYPE = 'strategy_putaway_strategytype',
  STRATEGY_WAVE_TRIGGERTYPE = 'strategy_wave_triggertype',
  STRATEGY_WAVE_GROUP_RULE = 'strategy_wave_group_rule',
  STRATEGY_PICK_STRATEGY_TYPE = 'strategy_pick_strategy_type',
  STRATEGY_PICK_PATH_PLAN_TYPE = 'strategy_pick_path_plan_type',
  STRATEGY_TURNOVER_STRATEGY_TYPE = 'strategy_turnover_strategy_type',
  STRATEGY_BATCH_STRATEGY_TYPE = 'strategy_batch_strategy_type',
  STRATEGY_BATCH_DATE_FORMAT = 'strategy_batch_date_format',
  STRATEGY_BATCH_VALIDITY_UNIT = 'strategy_batch_validity_unit',
  STRATEGY_BATCH_CIRCULATION_STATUS = 'strategy_batch_circulation_status',
  ...
  COUNT_DIFFERENCE_STATUS = 'count_difference_status',
  COUNT_DIFFERENCE_REASON = 'count_difference_reason',

  // ========== 库存冻结 ==========
  INVENTORY_FREEZE_OBJECT_TYPE = 'inventory_freeze_object_type',
  INVENTORY_FREEZE_REASON = 'inventory_freeze_reason',
  INVENTORY_FREEZE_STATUS = 'inventory_freeze_status',

  // wms 入库
  WMS_INBOUND_TYPE = 'WMS_INBOUND_TYPE',
  WMS_ASN_STATUS = 'WMS_ASN_STATUS',
  WMS_PACKAGE_UNIT = 'WMS_PACKAGE_UNIT',
  ...
  INSPECTION_RESULT = 'inspection_result', // 检验结果
  ORDER_STATUS = 'order_status', // 单据状态
  ...
  INVENTORY_TRANSFER_TYPE = 'inventory_transfer_type', // 调拨类型
  ...
  // 合作伙伴
  COOPERPARTNERS_PUNTER = 'cooperpartners_punter',

...
const list: PurchaseRequest[] = [
  ...
  },
  {
    ...
    status: 'FEISHU_APPROVED', currentNode: '已通过', feishuApprovalCode: 'FS-PR-2026-04-0005', feishuApprovalUrl: 'https://applink.feishu.cn/client/mini_program/open?appId=mock&approval=FS-PR-2026-04-0005',
    approvalNodes: [
  ...
  },
  {
    ...
    status: 'FEISHU_APPROVING', currentNode: '部门负责人', feishuApprovalCode: 'FS-PR-2026-04-0006', feishuApprovalUrl: 'https://applink.feishu.cn/client/mini_program/open?appId=mock&approval=FS-PR-2026-04-0006',
    approvalNodes: [
  ...
  },
  {
    ...
    status: 'FEISHU_APPROVED', currentNode: '已通过', feishuApprovalCode: 'FS-PR-2026-04-0007', feishuApprovalUrl: '',
    approvalNodes: [
  ...
  },
  {
    ...
    status: 'FEISHU_REJECTED', currentNode: '已驳回', feishuApprovalCode: 'FS-PR-2026-04-0008', feishuApprovalUrl: '',
    approvalNodes: [
